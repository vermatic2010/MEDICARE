...
`;
  ...
  // RAG-ENHANCED SYMPTOM CHECKER (True Retrieval-Augmented Generation)
...
`;
  ...
  // COMPREHENSIVE INTENT EXTRACTION for all HealthConnect interactions
...
Extract all relevant entities and normalize formats. Set unused fields to null.`;
  ...
  // WELLNESS INTENT EXTRACTION for wellness chat workflows
...
Convert names to lowercase usernames (remove spaces). Identify numbers as IDs.`;
  ...
  // RAG-ENHANCED NUTRITION/FOOD ANALYSIS
